...
public class TestSpecification implements Specification {
  ...
  private Root<TestAccessControlEntity> root;

  private CriteriaBuilder builder;

  private Predicate predicate;

  public TestSpecification(CriteriaBuilder builder, Root<TestAccessControlEntity> root) {
  ...
  public Specification and(Specification... specifications) {
    ...
    for (int i = 0; i < specifications.length; i++) {
      ...
      predicates[i] = ((TestSpecification) specification).getPredicate();
    }
